...
var config = {
  apiOrigins: {
    ...
    production: 'https://keephouse.herokuapp.com/'
  }
};
...
var taskApi = __webpack_require__(8);
var showTasksTemplate = __webpack_require__(17);
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('.tasklist').show();
  $('#sign-out').show();
  taskApi.getTasks().then(getTasksSuccess).catch(getTasksError);
};
...
var newTaskError = function newTaskError() {
...
var getTasksSuccess = function getTasksSuccess(data) {
  ...
  $('.delete-task-btn').on('click', onDeleteTask);
  $('.edit-task-btn').on('click', function (event) {}).on('click', onEditTask);
};

var getTasksError = function getTasksError() {
...
var onDeleteTask = function onDeleteTask(event) {
  var selectTaskId = $(event.target).parent().parent().data('id');
  taskApi.deleteTask(selectTaskId).then(deleteTaskSuccess).catch(deleteTaskError);
};
...
var deleteTaskError = function deleteTaskError() {
...
var onEditTask = function onEditTask(event) {
  var selectTaskId = $(event.target).parent().parent().data('id');
  var taskField = $(event.target).parent().siblings()[0];
  var notesField = $(event.target).parent().siblings()[1];
...
var onConfirmTask = function onConfirmTask(selectTaskId, taskField, notesField) {
  var newTask = $(taskField).html();
  var newNote = $(notesField).html();
  var data = {
    task: {
      task: newTask,
      notes: newNote
  ...
  taskApi.editTask(selectTaskId, data).then(onEditTaskSuccess).catch(onEditTaskFailure);
};

var onEditTaskSuccess = function onEditTaskSuccess() {
  clearTable();
...
var onEditTaskFailure = function onEditTaskFailure() {
...
module.exports = {
  ...
  onEditTaskSuccess: onEditTaskSuccess,
  onEditTaskFailure: onEditTaskFailure
};
...
var editTask = function editTask(selectTaskId, data) {
  return $.ajax({
...
var taskEvents = __webpack_require__(35);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<tr data-id=\""
    ...
    + "\">\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.task : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "</td>\n  <td>\n    <button class=\"btn btn-default edit-task-btn\">Edit</button>\n    <button class=\"btn btn-default delete-task-btn\">Delete</button>\n  </td>\n</tr>\n\n";
...
var onNewTask = function onNewTask(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.newTask(data).then(ui.newTaskSuccess).catch(ui.newTaskError);
};

var onGetTasks = function onGetTasks() {
  event.preventDefault();
  api.getTasks().then(ui.getTasksSuccess).catch(ui.getTasksError);
};
